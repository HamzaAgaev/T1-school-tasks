...
public class CustomJsonDeserializer<T> extends JsonDeserializer<T> {
    ...
    private T safeDeserialize(Supplier<T> deserializer, byte[] data) {
        try {
    ...
    public T deserialize(String topic, Headers headers, byte[] data) {
        return safeDeserialize(() -> super.deserialize(topic, headers, data), data);
    }

    @Override
    public T deserialize(String topic, byte[] data) {
        return safeDeserialize(() -> super.deserialize(topic, data), data);
    }
}
